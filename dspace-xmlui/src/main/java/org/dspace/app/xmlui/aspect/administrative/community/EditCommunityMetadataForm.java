...
public class EditCommunityMetadataForm extends AbstractDSpaceTransformer {
    ...
    private static final Message T_label_start_date = message("xmlui.administrative.community.EditCommunityMetadataForm.label_start_date");
	private static final Message T_label_end_date = message("xmlui.administrative.community.EditCommunityMetadataForm.label_end_date");
    private static final Message T_label_introductory_text = message("xmlui.administrative.community.EditCommunityMetadataForm.label_start_date");
    private static final Message T_label_copyright_text = message("xmlui.administrative.community.EditCommunityMetadataForm.label_end_date");
    ...
    public void addBody(Body body) throws WingException, SQLException, AuthorizeException {
		...
		/*if(!StringUtils.isBlank(communityIDString)) {
            communityID = UUID.fromString(communityIDString);
	    ...
	    //String start_date_error = FlowContainerUtils.checkXMLFragment(communityService.getMetadata(thisCommunity, "start_date"));
	    //String end_date_error = FlowContainerUtils.checkXMLFragment(communityService.getMetadata(thisCommunity, "end_date"));
        ...
        //	// fecha de inicio del proyecto
	   	//	metadataList.addLabel(T_label_start_date);
        //      
        //	Text start_date = metadataList.addItem().addText("start_date");

        //	String contenido = communityService.getMetadata(thisCommunity, "start_date");

        //	start_date.setValue(contenido);
        //	start_date.setSize(10);

       // 	if (start_date_error != null) {
         //   	start_date.addError(start_date_error);
        //	}
           
        	// fecha de finalización del proyecto
	    	//metadataList.addLabel(T_label_end_date);
                
        	//Text end_date = metadataList.addItem().addText("end_date");

        	//contenido = communityService.getMetadata(thisCommunity, "end_date");

        	//end_date.setValue(contenido);
        //	end_date.setSize(10);

        	//if (end_date_error != null) {
            	//end_date.addError(end_date_error);
        	//}
        //}
	    
	   // if(parentCommunity != null) {
	    
	    	// introductory text -> start date
	    	metadataList.addLabel(T_label_introductory_text);
	    	Text introductory_text = metadataList.addItem().addText("introductory_text");
	    	introductory_text.setValue(communityService.getMetadata(thisCommunity, "introductory_text"));
	    	introductory_text.setSize(10);

	    	if (introductory_text_error != null) {
	    		introductory_text.addError(introductory_text_error);
	    	}
	    
	    	// copyright text -> end date
	    	metadataList.addLabel(T_label_copyright_text);
	    	Text copyright_text = metadataList.addItem().addText("copyright_text");
	    	copyright_text.setValue(communityService.getMetadata(thisCommunity, "copyright_text"));
	    	copyright_text.setSize(10);
